...
export default function ServiceProviderReviewsPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch provider profile with all data including reviews and services
      const profileResponse = await apiCall(`/services/providers/${providerId}/profile`);
      ...
      if (profileResponse.status === 'success') {
        ...
        setProvider({
          ...
          image: providerData.avatar || '/images/default-avatar.jpg',
          coverImage: '/images/services/default-cover.jpg',
          category: 'Service Provider',
          rating: providerData.stats.averageRating,
          totalReviews: providerData.stats.totalReviews,
          completedJobs: providerData.stats.totalServices,
          responseTime: 'Within 24 hours',
          verified: true
        });

        // Set reviews from provider profile
        const reviews = providerData.recentReviews || [];
        setReviews(reviews);
        ...
        if (reviews.length > 0) {
          ...
          setReviewSummary({
            ...
            averageRating: providerData.stats.averageRating,
